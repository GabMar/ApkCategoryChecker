 ...
 * @author Gabriele Martini
 */
public class FactoryJsonBuilder {
	
	/*Constructor*/
    private FactoryJsonBuilder() {
    }
     ...
     * @return
     */
    public static FactoryJsonBuilder getInstance() {
        return FactoryJsonBuilderHolder.INSTANCE;
    }
    
    private static class FactoryJsonBuilderHolder {

        private static final FactoryJsonBuilder INSTANCE = new FactoryJsonBuilder();
    }
    ...
    public JsonBuilder getJsonBuilder() {
    	...
    	builder = new DefaultJsonBuilder();
